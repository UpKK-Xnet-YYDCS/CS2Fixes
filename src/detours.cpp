...
void InitDetours(CGameConfig* gameConfig)
{
	...
	g_bSetModelApiReady = gameConfig->ResolveSignature("CBaseModelEntity_SetModel") != nullptr;
}
...
std::int32_t SetModelFromApi(void* pModel, const char* pszModel)
{
	...
	KHook::Recall<void (CBaseModelEntity::*)(const char*)>(nullptr, {KHook::Action::Ignore}, static_cast<CBaseModelEntity*>(pModel), pszModel);
	return 1;
}
